...
public class OberonSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey @NotNull [] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(OberonTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        }
        if (tokenType.equals(OberonTypes.KEY)) {
            return KEY_KEYS;
        }
        if (tokenType.equals(OberonTypes.VALUE)) {
            return VALUE_KEYS;
        }
        if (tokenType.equals(OberonTypes.COMMENT)) {
            return COMMENT_KEYS;
        }
